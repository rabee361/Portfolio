  ...
  return (
        <section ref={ref} id="demo" className='h-screen w-full flex flex-row items-center justify-between overflow-hidden overflow-x-hidden'>
          <motion.div variants={pageVariants} initial="initial" animate={mainControls} className="w-2/3 h-screen pl-20 flex flex-col justify-center">
              <div className="justify-centertext-3xl font-extrabold tracking-tight leading-none flex flex-col gap-5 dark:text-white md:text-3xl lg:text-4xl">
              ...
              <div className="mt-10 w-full space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                  <a href="#" className="ease-linear duration-300 inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center dark:text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                      Download Demo
